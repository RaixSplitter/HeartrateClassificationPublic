...
class dummy_video_encoder(nn.Module):
    def __init__(self):
        super(dummy_video_encoder, self).__init__()
...
class dummy_rr_encoder(nn.Module):
    def __init__(self):
        super(dummy_rr_encoder, self).__init__()
...
class dummy_model(nn.Module):
    def __init__(self):
        ...
        self.video_encoder = dummy_video_encoder()
        self.rr_encoder = dummy_rr_encoder()

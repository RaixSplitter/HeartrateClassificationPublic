...
class CNN_Video_Encoder(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv3d(2, 8, kernel_size=(3,3, 5), stride = 1) 
        self.proj2 = nn.Conv3d(8, 4, kernel_size=(1,1,1), stride = (1,1,1))
        self.conv3 = nn.Conv3d(4, 16, kernel_size=(3,3, 5), stride = 1) 
        self.proj3 = nn.Conv3d(16, 8, kernel_size=(1,1,1), stride = (1,1,1))
...
class CNN_Proj_Model(nn.Module):
    def __init__(self):
        super(CNN_Proj_Model, self).__init__()
